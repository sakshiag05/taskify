...
const seed = async () => {
  ...
  const admin = db.prepare(`INSERT INTO users (name, email, password, role) VALUES (?, ?, ?, ?)`).run('Sakshi', 'sakshi@taskmanager.io', hashedAdmin, 'admin');
  ...
  console.log('  Admin: sakshi@taskmanager.io / Admin@123');
